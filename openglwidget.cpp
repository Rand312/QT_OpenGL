...
float ratio=0.5;
QPoint deltaPos;
RandOpenGLWidget::RandOpenGLWidget(QWidget *parent) : QOpenGLWidget(parent)
{
...
RandOpenGLWidget::~RandOpenGLWidget()
{
    makeCurrent();
...
void RandOpenGLWidget::drawShape(RandOpenGLWidget::Shape shape)
{
    m_shape=shape;
    update();
}

void RandOpenGLWidget::setWirefame(bool wireframe)
{
    makeCurrent();
    if(wireframe)
...
void RandOpenGLWidget::initializeGL()
{
...
void RandOpenGLWidget::resizeGL(int w, int h)
{
    Q_UNUSED(w);Q_UNUSED(h);
    //glViewport(0, 0, w, h);
}

void RandOpenGLWidget::paintGL()
{
    QMatrix4x4 model;
    QMatrix4x4 view;
...
#include <QKeyEvent>
void RandOpenGLWidget::keyPressEvent(QKeyEvent *event)
{
...
void RandOpenGLWidget::mouseMoveEvent(QMouseEvent *event)
{
...
void RandOpenGLWidget::wheelEvent(QWheelEvent *event)
{
...
void RandOpenGLWidget::on_timeout()
{
    update();
}
